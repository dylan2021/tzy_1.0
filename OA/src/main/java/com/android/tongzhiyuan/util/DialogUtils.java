...
public class DialogUtils {
    ...
    public static MaterialDialog.Builder getInputDialog(FragmentActivity context, String hint) {
    ...
    public static MaterialDialog.Builder getMoneyInputDialog(FragmentActivity context) {
        final EditText et = new EditText(context);
        et.setPadding(100, 0, 100, 50);
        et.setBackground(null);
        et.setHint("请输入");
