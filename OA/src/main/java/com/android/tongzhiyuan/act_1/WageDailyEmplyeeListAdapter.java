...
public class WageDailyEmplyeeListAdapter extends BaseAdapter {
    ...
    public WageDailyEmplyeeListAdapter(FragmentActivity context, int type, int status) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            holder = new WageDailyEmplyeeListAdapter.ViewHolder();
